...
const updatePropertyResource = asyncHandler(async (req, res) => {
  const id = req.params.property_id || req.params.id;
  const updated = await propertyService.updatePropertyResources(id, req.body);
...
const setVerified = asyncHandler(async (req, res) => {
  ...
  const updated = await propertyService.setVerified(id, is_verified);
...
const buyProperty = asyncHandler(async (req, res) => {
  ...
  const result = await propertyService.buyProperty(property_id, user_id);
